      ...
      <div class="row">
        <div class="col-md-5 col-md-push-0">
          <div class="banner_content">
            <h1><font color="#ffffff">Find the right car for you.</font></h1>
            <p> <font color="#ffffff">We have more than Hundred Cars for you to Choose.</font> </p>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      ...
      <h2><p> waiting to see you drive soon</p></h2>
    </div>
    <div class="row"> 
    ...
    <div class="row">
      <div class="col-lg-3 col-xs-6 col-sm-3">
        <div class="fun-facts-m">
          <div class="cell">
            <h2><i class="fa fa-calendar" aria-hidden="true"></i>ONE+</h2>
